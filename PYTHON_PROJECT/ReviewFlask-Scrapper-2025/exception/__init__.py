...
class ReviewException(Exception):
    ...
    def get_detailed_error_message(error_message: Exception, error_detail: sys) -> str:
        ...
        """
        _, _, exec_tb = error_detail.exc_info()  # sys.exc_info()->(type,value,traceback) i want trace back there we find line no and file name
        ...
        [ {file_name} ] at 
        try block line number: [{try_block_line_number}] and except Exception block line number: [{exception_block_line_number}] 
    ...
    def get_detailed_error_message(error_message: Exception, error_detail: sys) -> str:
        ...
        if exec_tb is not None:
            ...
            exception_block_line_number = try_block_line_number = -1
